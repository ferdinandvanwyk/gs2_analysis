...
upar_i = field.get_field(in_file, 'upar_igomega_by_mode', 0)
upar_e = field.get_field(in_file, 'upar_igomega_by_mode', 1)
...
upar_i = field.field_to_real_space(upar_i)*rho_star
upar_e = field.field_to_real_space(upar_e)*rho_star

# Ion updar film
contours = field.calculate_contours(upar_i)
...
pf.make_film_2d(x, y, upar_i, plot_options=plot_options, options=options)

# Electron updar film
contours = field.calculate_contours(upar_e)
...
pf.make_film_2d(x, y, upar_e, plot_options=plot_options, options=options)
